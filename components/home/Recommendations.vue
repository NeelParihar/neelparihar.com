<template>
  <div class=" border-b border-dashed border-gray-200">
    <div class="max-w-7xl mx-auto border-l border-r border-dashed border-gray-200 pt-4 pb-6 px-4">
      <div class="max-w-prose text-center mx-auto pb-4">
        <p class="text-xs leading-6 text-primary font-semibold tracking-wide lowercase">{{ $t('recommendations.subtext')
          }}</p>
      ...
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div v-for="(rec, index) in $config.recommendations.meta" :key="`rec-${index}`"
          class="relative h-full  rounded-lg shadow-lg text-base w-full">
          <blockquote class="relative">
            <div class="rounded-t-lg px-5 py-5 sm:px-8 sm:py-8y">
              ...
              <div class="relative text-sm text-gray-600 font-medium mt-8">
                <svg class="absolute top-0 left-0 transform -translate-x-4 -translate-y-4 h-8 w-8 text-gray-100"
