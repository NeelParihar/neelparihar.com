...
<div class="max-w-7xl mx-auto border-gray-200 border-dashed border-l border-r">
            ...
            <header class="py-4">
              <div class="space-y-1 text-center">
                ...
                <div class="overflow-hidden flex flex-wrap items-center flex-row justify-center">
                    <div class="px-3 text-xs flex flex-shrink-0 py-1 mt-1 mr-2 bg-primary rounded-md hover:bg-hot-pink" v-for="(tag, index) in project.tags" :key="`tag-${index}`">{{ tag }}</div>
                </div>
              </div>
            </header>
  ...
  <div @click="scrollToTop" class="cursor-pointer fixed z-50 bottom-4 right-4 w-8 w-8 rounded-full bg-gray-900 text-white block text-primary hover:text-hot-pink">
