...
<div class="max-w-7xl mx-auto border-gray-200 border-dashed border-l border-r">
  <div class="dark antialiased text-black">
        ...
        <div class="space-y-9">
          <div class="py-0.5 border-t border-b border-dashed border-gray-700 flex items-center justify-between">
            <div class="text-primary font-bold">
              <nuxt-link class="hover:text-hot-pink" :to="localePath('/projects')">{{ $t('projects.header') }}</nuxt-link> <span class="text-gray-700">/</span> {{ project.tech }}
            </div>
